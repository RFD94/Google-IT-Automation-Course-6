...
import locale
import sys
from reports import generate as report_generate
...
def main(argv):
  ...
  report_generate('/tmp/cars.pdf', "Cars report", new_summary, cars_dict_to_table(data))
  # TODO: send the PDF report as an email attachment
  msg = email_generate("automation@example.com", "student-02-978867608d77@example.com", "Sales summary for last mont$
  email_send(msg)
